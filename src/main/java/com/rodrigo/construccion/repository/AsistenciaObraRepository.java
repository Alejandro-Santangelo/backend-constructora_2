...
public interface AsistenciaObraRepository extends JpaRepository<AsistenciaObra, Long> {
    ...
    List<AsistenciaObra> findByProfesionalObraId(@Param("profesionalObraId") Long profesionalObraId, @Param("empresaId") Long empresaId);
    ...
    List<AsistenciaObra> findByDireccionObra(@Param("calle") String direccionObraCalle, @Param("altura") String direccionObraAltura,
    ...
    Optional<AsistenciaObra> findByIdAndEmpresaId(@Param("id") Long id, @Param("empresaId") Long empresaId);
    ...
    @Query("SELECT a FROM AsistenciaObra a " +
            ...
            "AND a.empresaId = :empresaId")
    Optional<AsistenciaObra> findHoyByProfesionalObraId(@Param("profesionalObraId") Long profesionalObraId,
                                                        @Param("empresaId") Long empresaId
    );
    ...
    @Query("SELECT COUNT(a) > 0 FROM AsistenciaObra a " +
            ...
            "AND a.fecha = :fecha " +
            "AND a.empresaId = :empresaId")
    boolean existsByProfesionalObraIdAndFecha(@Param("profesionalObraId") Long profesionalObraId,
