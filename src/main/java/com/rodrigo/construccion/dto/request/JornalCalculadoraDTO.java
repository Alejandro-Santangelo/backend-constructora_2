...
public class JornalCalculadoraDTO {
    ...
    @Schema(description = "Rol o tipo de jornal", example = "Oficial Albañil", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Cantidad de jornales", example = "200.00", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "La cantidad es obligatoria")
    private BigDecimal cantidad;

    @Schema(description = "Valor unitario por jornal", example = "100000.00", requiredMode = Schema.RequiredMode.REQUIRED)
