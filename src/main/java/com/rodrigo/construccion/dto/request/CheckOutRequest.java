...
public class CheckOutRequest {
    ...
    @Schema(description = "Hora de salida", example = "17:30:00", required = true)
    private LocalTime horaSalida;

    @NotNull(message = "La latitud de salida es obligatoria")
    @Schema(description = "Latitud de ubicación de salida", example = "-34.603722", required = true)
    private Double latitudSalida;

    @NotNull(message = "La longitud de salida es obligatoria")
    @Schema(description = "Longitud de ubicación de salida", example = "-58.381592", required = true)
