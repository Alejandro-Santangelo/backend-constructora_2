...
/**
 * DTO Response para trabajos extra por día
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "Información completa de un trabajo extra por día")
public class TrabajoExtraResponseDTO {

    @Schema(description = "ID del trabajo extra")
    private Long id;

    @Schema(description = "ID de la obra padre")
    private Long obraId;

    @Schema(description = "ID del cliente (obtenido de la obra)")
    private Long clienteId;

    @Schema(description = "ID de la empresa")
    private Long empresaId;

    @Schema(description = "Nombre del trabajo extra")
    private String nombre;

    @Schema(description = "Observaciones del trabajo extra")
    ...
    @Schema(description = "Fecha probable de inicio")
    private LocalDate fechaProbableInicio;

    @Schema(description = "Fecha de vencimiento del presupuesto")
    private LocalDate vencimiento;

    @Schema(description = "Fecha de creación del presupuesto")
    private LocalDate fechaCreacion;

    @Schema(description = "Fecha de emisión del presupuesto")
    private LocalDate fechaEmision;

    @Schema(description = "Tiempo estimado de terminación en días")
    private Integer tiempoEstimadoTerminacion;

    @Schema(description = "Indica si se calculan días hábiles automáticamente")
    private Boolean calculoAutomaticoDiasHabiles;

    // Control de versiones y estado
    @Schema(description = "Versión del presupuesto")
    private Integer version;

    @Schema(description = "Número único del presupuesto")
    ...
    @Schema(description = "Total del presupuesto base")
    private BigDecimal totalPresupuesto;

    @Schema(description = "Total de honorarios")
    private BigDecimal totalHonorarios;

    @Schema(description = "Total de mayores costos")
    private BigDecimal totalMayoresCostos;

    @Schema(description = "Total final del presupuesto")
    private BigDecimal totalFinal;

    @Schema(description = "Monto total (alias para compatibilidad)")
    private BigDecimal montoTotal;

    // Marcador de trabajo extra
    @Schema(description = "Indica si es un trabajo extra")
    private Boolean esTrabajoExtra;

    @Schema(description = "Lista de días (fechas) del trabajo extra")
    private List<LocalDate> dias;

    @Schema(description = "Lista de profesionales asignados")
    private List<TrabajoExtraProfesionalResponseDTO> profesionales;

    @Schema(description = "Lista de tareas del trabajo extra")
    private List<TrabajoExtraTareaResponseDTO> tareas;
    ...
    private List<TrabajoExtraItemCalculadoraResponseDTO> itemsCalculadora;

    @Schema(description = "Total de honorarios calculado automáticamente")
    private BigDecimal totalHonorariosCalculado;

    @Schema(description = "Total del presupuesto incluyendo honorarios")
    private BigDecimal totalPresupuestoConHonorarios;

    @Schema(description = "Total de materiales")
    private BigDecimal totalMateriales;

    @Schema(description = "Total de profesionales")
    ...
    @Schema(description = "Honorario de dirección - importe")
    ...
    @Schema(description = "Configuración completa de honorarios")
    private HonorariosConfigDTO honorarios;

    @Schema(description = "Configuración completa de mayores costos")
